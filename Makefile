...
cube: libgtkgl-2.0.so moteur3D.ml modelisation.ml traitement_image.ml yellokarto.ml
	${OCAMLOPT} ${OCAMLFLAGS} ${OCAMLLD} -o yellokarto moteur3D.ml modelisation.ml traitement_image.ml yellokarto.ml
	rm -f *~ *.o *.cm?
