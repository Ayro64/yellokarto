...
cube: libgtkgl-2.0.so modelisation.ml traitement_image.ml yellokarto.ml
	${OCAMLOPT} ${OCAMLFLAGS} ${OCAMLLD} -o yellokarto modelisation.ml traitement_image.ml yellokarto.ml
	rm -f *~ *.o *.cm?
