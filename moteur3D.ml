...
let initGL _ =
  ...
  (* addTriangle (20., 10., 0.) (40., 8., 0.) (10., 40., 0.); *)
  (* addTriangle (40., 8., 0.) (10., 40., 0.) (30., 40., 0.); *)
  
  
  (*  addTriangle (!xminimal -. 255., !yminimal -. 255., !z1) (!xmaximal -. 255., !yminimal -. 255., !z2) (!xminimal -. 255., !ymaximal -. 255., !z3); *)
  (* addTriangle (!xmaximal -. 255., !yminimal -. 255., !z2) (!xminimal -. 255., !ymaximal -. 255., !z3) (!xmaximal -. 255., !ymaximal -. 255., !z4); *)
  ...
  GluMat.look_at (600., 600., 700.) (0., 0., 0.) ( 0., 0., 1.);
